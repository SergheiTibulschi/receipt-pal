...
public struct ItemDTO: Codable, JSONEncodable, Hashable, Identifiable {
    ...
    public init(description: String, quantity: Double, unitPrice: Double, amount: String, vatPercentage: String, vatAmount: Double, productType: String) {
